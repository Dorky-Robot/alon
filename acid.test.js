  ...
  it('correctly converts JSON to CSS', () => {
    const cssData = [
      ...
      [".grid-container", {
        ...
        "gap": "10px",
        "@media screen and (max-width: var(--max-width))": { // Use var(--max-width) to reference the custom property
          ".grid-container": {
            "gridTemplateColumns": { func: ["repeat", 1, "1fr"] } // Adjust the number of columns for smaller screens
          }
        }
      }],
      [".grid-item", {
